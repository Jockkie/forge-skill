...
Capability names differ per runtime. Read for the capability, not the tool name: subagent spawning may be a Task tool, a delegate call, or absent entirely.
...
If `FORGE-LOCAL.md` exists beside this file, read it first: it maps the roles in the README to the skills this installation actually has, and may override language, default depth, and agent id. Its absence is not an error.
